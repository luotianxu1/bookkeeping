export type ApiService = 'default' | 'auth' | 'finance' | 'admin'
...
const apiBaseUrls: Record<ApiService, string> = {
  ...
  finance: import.meta.env.VITE_FINANCE_API_BASE_URL ?? import.meta.env.VITE_API_BASE_URL ?? 'http://localhost:8081',
