...
CREATE TABLE IF NOT EXISTS accounts (
  ...
  loan_total_amount DECIMAL(18, 2) NULL COMMENT '贷款总额，仅负债账户使用',
  loan_interest_amount DECIMAL(18, 2) NULL COMMENT '兼容旧数据的贷款利息金额，仅负债账户使用',
  loan_interest_rate DECIMAL(10, 4) NULL COMMENT '贷款利率，仅负债账户使用，百分比值',
  loan_total_periods INT UNSIGNED NULL COMMENT '贷款总期数，仅负债账户使用',
  loan_repayment_day TINYINT UNSIGNED NULL COMMENT '每月还款日，仅负债账户使用',
  loan_start_date DATE NULL COMMENT '首期账单日期，仅负债账户使用',
  loan_settled_at DATETIME(3) NULL COMMENT '结清时间，仅负债账户使用',
