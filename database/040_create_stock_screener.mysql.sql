...
CREATE TABLE IF NOT EXISTS stock_screen_snapshots (
  ...
  first_board_high_bear_matched TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否命中首版高阴规则',
  first_board_buy_point VARCHAR(24) NULL COMMENT '首版高阴买点类型：反包/突破/低吸',
  first_board_score SMALLINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '首版高阴信号评分',
  first_board_date DATE NULL COMMENT '首版涨停日期',
  first_board_low DECIMAL(18,4) NULL COMMENT '首版涨停最低价',
  high_bear_date DATE NULL COMMENT '高阴线日期',
  high_bear_high DECIMAL(18,4) NULL COMMENT '高阴线最高价',
  high_bear_volume_ratio DECIMAL(10,4) NOT NULL DEFAULT 0 COMMENT '高阴量/首版量',
  created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '创建时间',
  PRIMARY KEY (id),
  ...
  KEY idx_stock_screen_snapshot_first_board (run_id, first_board_high_bear_matched, first_board_score),
